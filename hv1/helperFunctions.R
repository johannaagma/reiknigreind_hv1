...
# Fyrir: titlarnir á dálkunum í table (frá og með dálk 2) eru á 
#        forminu: "X15.19" og "X60.ára.og.eldri"
# Eftir: búið er að breyta þessum titlum yfir á formið: "15-19 ára" og
#        "60+ ára"
...
# Eftir: búið er að setja fyrsta gildið sem gefur eftir fyrstu tilkomu
#        tölustafs, t.d. "2001" og "35.39.ára"
renameVector <- function(vector) {
  list = c() # eða = character()
